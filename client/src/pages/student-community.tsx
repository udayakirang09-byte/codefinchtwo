      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto" data-testid="text-community-description">
            Connect with fellow learners, share projects, and learn together in our supportive community.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="text-center hover:shadow-lg transition-shadow" data-testid="card-projects">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                Show off your learning projects and get feedback
              </p>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow" data-testid="card-events">
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">
                Join learning challenges, workshops, and meetups
              </p>
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Connect with thousands of learners and accelerate your learning journey.
          </p>
