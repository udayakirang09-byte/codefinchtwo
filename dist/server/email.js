...
export function generateResetEmail(email, resetCode) {
...
export function generateCourseCancellationEmail(recipientEmail, recipientName, recipientRole, courseTitle, cancelledBy, cancelledClasses, keptClasses, refundAmount) {
...
export function generateClassDeletionEmail(recipientEmail, recipientName, recipientRole, classDate, mentorName, refundAmount) {
...
export function generateAbusiveLanguageAlertEmail(adminEmail, incident) {
